...
import { Plus, Trash2, Folder, GraduationCap } from 'lucide-react'
    ...
    return (
        <div>
            <div className='flex items-center justify-between'>
                ...
                <button onClick={addProject} className='flex items-center gap-2 px-3 py-1 text-sm bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 transition-colors disabled:opacity-50'>
