    ...
    return (
        <div className='space-y-6'>
            <div className='flex items-center justify-between'>
                ...
                <button onClick={addExperienceForm} className='flex items-center gap-2 px-3 py-1 text-sm bg-green-100 text-green-700 rounded-lg  hover:bg-green-200 transition-colors disabled:opacity-50'>
                    ...
                    {data.map((experience, index) => (
                        <div key={index} className='p-4 border border-gray-200 rounded-lg space-y-3'>
                            ...
                            <label className="flex items-center gap-2">
                                ...
                                />
                                <span className='text-sm text-gray-700 ml-2'>Currently Working Here</span>
                            </label>
