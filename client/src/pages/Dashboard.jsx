...
import { PencilIcon, PlusIcon, TrashIcon, UploadCloudIcon, FilePenLineIcon, XIcon, LoaderCircleIcon } from "lucide-react";
...
const Dashboard = () => {
    ...
    const deleteResume = async (resumeId) => {
        ...
        try {
            const confirm = window.confirm('Are you sur you want to delete this resume?')
            if (confirm) {
    ...
    return (
        <div>
            ...
            bg-clip-text text-transparent sm:hidden'>Welcome, Joe Doe</p>
                ...
                <hr className='border-slate-300 my-6 sm:max-w-md w-full' />
