...
const ResumeBuilder = () => {
    ...
    const changeResumeVisibility = async () => {
       try {
        ...
        // keep local state in sync so the Private/Public toggle updates immediately
            ...
            <div className='max-w-7xl mx-auto px-4 pb-8'>
                ...
                <div className='relative lg:col-span-5 rounded-lg overflow-hidden'>
                    <div className='bg-white rounded-lg shadow-sm border border-gray-200 p-6 pt-1'>
                        ...
                        <hr className="absolue top-0 left-0 h-1 bg-gradient-to-r 
                        ...
                        <div className="flex justify-between items-center mb-6 border-b border-gray-300 py-1">
                            ...
                            <div className="flex items-center gap-2">
                                <TemplatesSelector selectedTemplate={resumeData.template} onChange={(template)=>
                ...
                <button onClick={() => toast.promise(saveResume, { loading: 'Saving....' })} className="bg-gradient-to-br from-geen-100 to-green-200

                        ring-green-300 text-green-600 ring hover:ring-green-400 transition-allowed
